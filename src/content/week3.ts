...
export const week3Words: Word[] = [
  ...
  { id: 'get', text: 'get', category: 'operation', definition: 'to come to have something', chinese: '得到；到达', example: 'I get up in the morning.', weekIntroduced: 3, tags: ['action'] },
  { id: 'up', text: 'up', category: 'structure', definition: 'to a high place or out of bed', chinese: '向上；起身', example: 'I get up.', weekIntroduced: 3, tags: ['action'] },
  ...
  { id: 'water', text: 'water', category: 'general_thing', definition: 'clear drink used for washing', chinese: '水', example: 'I drink water.', weekIntroduced: 3, tags: ['daily'] },
  ...
  { id: 'clothes', text: 'clothes', category: 'general_thing', definition: 'things on a person', chinese: '衣服', example: 'I put on my clothes.', weekIntroduced: 3, tags: ['daily'] },
  ...
  { id: 'school', text: 'school', category: 'general_thing', definition: 'a place where persons study', chinese: '学校', example: 'I go to school.', weekIntroduced: 3, tags: ['place'] },
  { id: 'work', text: 'work', category: 'operation', definition: 'to do a useful act', chinese: '工作', example: 'I go to work.', weekIntroduced: 3, tags: ['daily'] },
  ...
  { id: 'road', text: 'road', category: 'picturable_thing', definition: 'a way for walking or moving', chinese: '路', example: 'I walk on the road.', weekIntroduced: 3, tags: ['place'] },
  { id: 'bus', text: 'bus', category: 'picturable_thing', definition: 'a great carriage for persons', chinese: '公交车', example: 'I go by bus.', weekIntroduced: 3, tags: ['travel'] },
  ...
  { id: 'do', text: 'do', category: 'operation', definition: 'to make an act', chinese: '做', example: 'I do my work.', weekIntroduced: 3, tags: ['action'] },
  { id: 'make', text: 'make', category: 'operation', definition: 'to put together or get ready', chinese: '做；制作', example: 'I make food.', weekIntroduced: 3, tags: ['action'] },
  ...
  { id: 'read', text: 'read', category: 'operation', definition: 'to get meaning from words', chinese: '读', example: 'I read a book.', weekIntroduced: 3, tags: ['study'] },
  { id: 'write', text: 'write', category: 'operation', definition: 'to make words with a pen', chinese: '写', example: 'I write on paper.', weekIntroduced: 3, tags: ['study'] },
  { id: 'afternoon', text: 'afternoon', category: 'general_thing', definition: 'the part of the day after morning', chinese: '下午', example: 'I study in the afternoon.', weekIntroduced: 3, tags: ['time'] },
  ...
  { id: 'before', text: 'before', category: 'structure', definition: 'in front of another time or action', chinese: '在……之前', example: 'I wash before I go.', weekIntroduced: 3, tags: ['time'] },
  { id: 'after', text: 'after', category: 'structure', definition: 'coming past another time or action', chinese: '在……之后', example: 'I study after food.', weekIntroduced: 3, tags: ['time'] },
  ...
  { id: 'meal', text: 'meal', category: 'general_thing', definition: 'food at one time', chinese: '一餐', example: 'I have a meal.', weekIntroduced: 3, tags: ['food'] },
  ...
  { id: 'start', text: 'start', category: 'operation', definition: 'to come to the first part', chinese: '开始', example: 'I start my work.', weekIntroduced: 3, tags: ['sequence'] },
  ...
  { id: 'often', text: 'often', category: 'structure', definition: 'much of the time', chinese: '经常', example: 'I often read.', weekIntroduced: 3, tags: ['frequency'] },
  ...
  { id: 'practice', text: 'practice', category: 'operation', definition: 'to do something again to get good at it', chinese: '练习', example: 'I practice English every day.', weekIntroduced: 3, tags: ['study'] },
