...
// British IPA for the meaning taught here; record and wind are nouns.
const phonetics = {
  family: '/ˈfæməli/', mother: '/ˈmʌðə/', father: '/ˈfɑːðə/', brother: '/ˈbrʌðə/',
  sister: '/ˈsɪstə/', baby: '/ˈbeɪbi/', boy: '/bɔɪ/', girl: '/ɡɜːl/', man: '/mæn/', woman: '/ˈwʊmən/',
  sun: '/sʌn/', rain: '/reɪn/', cloud: '/klaʊd/', wind: '/wɪnd/', weather: '/ˈweðə/',
  cold: '/kəʊld/', heat: '/hiːt/', garden: '/ˈɡɑːdən/', tree: '/triː/', flower: '/ˈflaʊə/',
  office: '/ˈɒfɪs/', meeting: '/ˈmiːtɪŋ/', letter: '/ˈletə/', page: '/peɪdʒ/', copy: '/ˈkɒpi/',
  print: '/prɪnt/', record: '/ˈrekɔːd/', number: '/ˈnʌmbə/', mark: '/mɑːk/', account: '/əˈkaʊnt/',
  like: '/laɪk/', love: '/lʌv/', fear: '/fɪə/', hope: '/həʊp/', idea: '/aɪˈdɪə/',
  thought: '/θɔːt/', reason: '/ˈriːzən/', true: '/truː/', false: '/fɔːls/', possible: '/ˈpɒsəbəl/',
  will: '/wɪl/', tomorrow: '/təˈmɒrəʊ/', yesterday: '/ˈjestədeɪ/', week: '/wiːk/', month: '/mʌnθ/',
  year: '/jɪə/', summer: '/ˈsʌmə/', winter: '/ˈwɪntə/', north: '/nɔːθ/', south: '/saʊθ/',
} satisfies Record<string, string>;

function word(
  id: keyof typeof phonetics,
...
function weeklyRubric(topic: string): WeeklyCheckRubric {
  return {
    ...
    criteria: [
      ...
      { id: 'word-use', label: 'Word use', scores: [`not enough ${topic} words`, `some ${topic} words`, `enough ${topic} words`] },
...
export const week12 = simpleWeek('week-12', 12, 'Time and Place', 'Tell yesterday, tomorrow, summer, winter, and place stories.', [
  ...
  makeDay({ dayNumber: 80, weekId: 'week-12', title: 'Week, Month, Year', goal: 'Say week, month, and year.', wordIds: ['week', 'month', 'year', 'day', 'time', 'good'], patternIds: ['this-week'], choicePrompt: 'Which sentence says this week?', choiceOptions: ['This week is good.', 'The wind is cold.', 'I love my family.'], correctOption: 'This week is good.', fillPrompt: 'This ___ is good.', fillAnswers: ['week', 'month', 'year'], orderTokens: ['week', 'good', 'is', 'This'], order: ['This', 'week', 'is', 'good'], finalSentence: 'This week is good.', secondFillPrompt: 'A week has ___ days.', secondFillAnswers: ['7'], secondChoicePrompt: 'Which sentence uses year?', secondChoiceOptions: ['This year is good.', 'I copy a page.', 'There is a cloud.'], secondCorrectOption: 'This year is good.', chinesePrompt: '这一周很好。一周有七天。今年很好。', meaningHint: 'Say week, month, and year.', suggestedPatternIds: ['this-week'], referenceAnswers: ['This week is good. A week has 7 days. This year is good.'], outputTopic: 'Week Month Year', outputPrompts: ['How is this week?', 'How is this year?'], outputTemplate: ['This week is good.', 'A week has 7 days.', 'This year is good.', 'Time is important.'], storyPrompt: 'Make a short story about week, month, and year.' }),
