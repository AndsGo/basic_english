...
describe('CoursePage', () => {
  ...
  it('shows all thirteen weeks complete after Day 91 is complete', () => {
    ...
    expect(screen.getAllByText('7 / 7 days completed')).toHaveLength(46);
    ...
    expect(day238Card).not.toBeNull();
    expect(within(day238Card!).getByText('Completed')).toBeInTheDocument();
  });
});
